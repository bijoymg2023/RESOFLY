...
def send_email_to_all(url, recipients):
    ...
    try:
        ...
        # Prepare ONE email with BCC
        print(f"Sending ONE email with BCC to: {recipients}...")
        
        msg = MIMEMultipart()
        msg['From'] = EMAIL_SENDER
        msg['To'] = EMAIL_SENDER # 'To' field is sender (self) to hide recipients
        msg['Bcc'] = ", ".join(recipients) # Real recipients in BCC
        msg['Subject'] = "ResoFly System Online 🚀"
        ...
        # Send once
        server.sendmail(EMAIL_SENDER, recipients, msg.as_string()) # Sendmail function takes the raw list

        server.quit()
        print("Email batch sent successfully.")
