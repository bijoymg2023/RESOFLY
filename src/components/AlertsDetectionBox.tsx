...
const alertConfig = {
    ...
    other: { icon: Target, color: 'text-white/50', bg: 'bg-white/5', border: 'border-white/10' },
};
        ...
        <Card className="bg-[#0A0A0A]/90 border border-white/10 backdrop-blur-sm flex flex-col overflow-hidden shadow-xl h-full min-h-[280px]">
            <CardHeader className="py-3 px-4 border-b border-white/5 bg-black/40 flex flex-row items-center justify-between">
                <div className="flex items-center space-x-2">
                    ...
                    <CardTitle className="text-xs font-mono uppercase tracking-widest text-white/60">Active Threats</CardTitle>
                </div>
                            ...
                            activeAlerts.map((alert) => {
                                ...
                                return (
                                    <div
                                        key={alert.id}
                                        className={`
                                            relative group flex flex-col p-3 rounded-md transition-all duration-300
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-white/70 mb-3">
                                        ...
                                        <div className="flex space-x-2">
                                            <Button
                                                size="sm"
                                                variant="outline"
                                                className="flex-1 h-7 text-[10px] border-white/10 hover:bg-white/10 bg-black/40"
