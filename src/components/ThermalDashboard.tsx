                ...
                <div className="mt-3 pt-2 sm:pt-3 border-t border-border">
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="text-center p-2 bg-muted/20 rounded-md">
                      <div className="text-primary font-bold text-sm">98%</div>
                      <div className="text-muted-foreground text-xs">Uptime</div>
                    </div>
                    <div className="text-center p-2 bg-muted/20 rounded-md">
                      <div className="text-success font-bold text-sm">42°C</div>
                      <div className="text-muted-foreground text-xs">Max Temp</div>
                    </div>
                  </div>
                </div>
              </CardContent>
